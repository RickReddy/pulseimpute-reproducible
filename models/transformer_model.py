...
class transformer():
    def __init__(self, modelname, data_name, train_data=None, val_data=None, 
                imputation_dict= None, annotate="",annotate_test="",
                 ...
                 reload_epoch=-1,
                 convertolong=None, reload_epoch_long=None, model_weights_path=None,
                 freeze_layer_1=None, freeze_layer_23=None, freeze_layer_4=None, retrain_for_X_epochs=None):
        outpath = "out/"
        self.iter_save = iter_save
        self.retrain_for_X_epochs = retrain_for_X_epochs # added by RG
        ...
        self.model =  nn.DataParallel(model_module_class(orig_dim=self.total_channels,
            max_len=max_len, freeze_layer_1=freeze_layer_1, freeze_layer_23=freeze_layer_23, freeze_layer_4=freeze_layer_4), device_ids=self.gpu_list)
        ...
        if convertolong:
            ...
            if model_weights_path: # this is where we are loading a longformer epoch
            ...
            elif reload_epoch_long: # this is where we are loading a longformer epoch
    ...
    def train(self):
        ...
        # added by RG, below block of code
        if self.retrain_for_X_epochs:
            for epoch in range(np.max(self.epoch_list)+1, np.max(self.epoch_list)+self.retrain_for_X_epochs):
        ...
        # block of code above inserted by RG, previous behavior pasted below
